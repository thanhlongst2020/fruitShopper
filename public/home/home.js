...
const AppleFunction = () =>{
    Fruit.src = "Fruits_store/img/apple-slice.png";
    BackgroundLayout.style.backgroundImage = "url('Fruits_store/img/apple_bg.png')";
...
const OrangeFunction = () =>{
    Fruit.src = "Fruits_store/img/orange-slice.png";
    BackgroundLayout.style.backgroundImage = "url('Fruits_store/img/orange_bg.png')";
...
const BananaFunction = () =>{
    Fruit.src = "Fruits_store/img/banana-slice.png";
    BackgroundLayout.style.backgroundImage = "url('Fruits_store/img/banana_bg.png')";
...
const StrawFunction = () =>{
    Fruit.src = "Fruits_store/img/straw-slice.png";
    BackgroundLayout.style.backgroundImage = "url('Fruits_store/img/straw_bg.png')";
